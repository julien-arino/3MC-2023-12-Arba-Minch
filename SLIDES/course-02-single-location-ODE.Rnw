...
\maxFrameImage{FIGS/dedication-Fred-Brauer-43.png}
...
\maxFrameImage{FIGS/Korobeinikov-2004.png}

\frame{\frametitle{Lyapunov function for SLIR and SLIS}
Consider an SLIR in constant population (normed to 1), with vertical transmission
...
\maxFrameImage{FIGS/LiMuldowneyPvdD.png}
...
\begin{frame}{Liu, Levin and Iwasa}
SIRS of the form
...
%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%
\subsection{A model of Capasso for environmentally transmitted pathogens}

\maxFrameImage{FIGS/LNB-54.png}
